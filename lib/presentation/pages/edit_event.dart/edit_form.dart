...
class EditEventForm extends StatefulWidget {
  final CalendarEvent initEvent;

  const EditEventForm({required this.initEvent, super.key});
            ...
            children: <Widget>[
              ListTile(
                ...
                title: AppTextFormField(
                  initialValue: widget.initEvent.name,
                  validator: (value) {
              ...
              ListTile(
                ...
                subtitle: FormField<DateTime>(
                  ...
                  initialValue: widget.initEvent.startDateTime,
              ...
              ListTile(
                ...
                subtitle: FormField<DateTime>(
                  ...
                  initialValue: widget.initEvent.endTime(),
              ...
              ListTile(
                ...
                subtitle: FormField<EventCategory?>(
                  ...
                  initialValue: widget.initEvent.category,
                  builder: (field) => ElevatedButton(
                    onPressed: () async {
              ...
              ListTile(
                  ...
                  subtitle: AppTextFormField(
                    initialValue: widget.initEvent.description,
                    key: _descriptionKey,
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      CalendarEvent updatedEvent = CalendarEvent(
                          ...
                          id: widget.initEvent.id);

                      context
                          .read<SingleEventCubit>()
                          .updateEvent(updatedEvent, widget.initEvent);
                    }
                  },
